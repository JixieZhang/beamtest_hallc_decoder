...
void DoPedestal(int run_start, int run_end)
{
  ...
  for (int run=run_start;run<=run_end;run++) {
    ...
    if(run>=3786 && run<=3808) {
      sprintf(filename,"../ROOTFILE/cosmic1/beamtest_hallc_%4d_0.root",run);  //3786-3808
    } else if(run>=3863 && run<=3885) {
      sprintf(filename,"../ROOTFILE/cosmic2/beamtest_hallc_%4d_0.root",run);  //3863-3885
    } else if(run>=3886 && run<=3895) {
      sprintf(filename,"../ROOTFILE/cosmic3/beamtest_hallc_%4d_0.root",run);  //3886-3895
    } else if(run>=3896 && run<=3905) {
      sprintf(filename,"../ROOTFILE/cosmic4/beamtest_hallc_%4d_0.root",run);  //3898-3905
    } else {
...
void DoLevel1Tree(int run_start, int run_end)
{
  ...
  for (int run=run_start;run<=run_end;run++) {
    ...
    for (int subrun=0;subrun<500;subrun++) {
      ...
      if(run>=3786 && run<=3808) {
        sprintf(filename,"../ROOTFILE/cosmic1/beamtest_hallc_%4d_%d.root",run,subrun);  //3786-3808
      } else if(run>=3863 && run<=3885) {
        sprintf(filename,"../ROOTFILE/cosmic2/beamtest_hallc_%4d_%d.root",run,subrun);  //3863-3885
      } else if(run>=3886 && run<=3895) {
        sprintf(filename,"../ROOTFILE/cosmic3/beamtest_hallc_%4d_%d.root",run,subrun);  //3886-3895
      } else if(run>=3896 && run<=3905) {
        sprintf(filename,"../ROOTFILE/cosmic4/beamtest_hallc_%4d_%d.root",run,subrun);  //3898-3905
      } else {
...
void DoLevel1Tree_cosmic4(int run_start, int run_end)
{
