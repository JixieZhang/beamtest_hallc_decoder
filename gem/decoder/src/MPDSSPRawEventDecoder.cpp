        ...
        [[maybe_unused]]uint32_t fBufLen, std::vector<int> &vTagTrack)
{
    ...
    //Clear();
    //
    // 08/08/2022 xinzhan: I am developping for hallc test,
    //                     hall c test only has one single crate, and
    //                     plus I am not using my event_parser,
    //                     I am using Chao Peng's event_parser.
    //                     So I have to do Clear() in here.
    Clear();
