        ...
        case kSSP:
            {
                ...
                tree->Branch((sname + "_prodID").c_str(),       &event->Prod[0],         (sname + "prodID[nCluster]/I").c_str());
                tree->Branch((sname + "_moduleID").c_str(),     &event->Module[0],       (sname + "moduleID[nCluster]/I").c_str());
                tree->Branch((sname + "_axis").c_str(),         &event->Axis[0],         (sname + "axis[nCluster]/I").c_str());
                tree->Branch((sname + "_size").c_str(),         &event->Size[0],         (sname + "size[nCluster]/I").c_str());
                tree->Branch((sname + "_adc").c_str(),          &event->Adc[0],          (sname + "adc[nCluster]/F").c_str());
                tree->Branch((sname + "_pos").c_str(),          &event->Pos[0],          (sname + "pos[nCluster]/F").c_str());
                tree->Branch((sname + "_stripNo").c_str(),      &event->StripNo[0][0],   (sname + "stripNo[nCluster][MAXCLUSTERSIZE]/I").c_str());
                tree->Branch((sname + "_stripAdc").c_str(),     &event->StripAdc[0][0],  (sname + "stripADC[nCluster][MAXCLUSTERSIZE]/F").c_str());
                tree->Branch((sname + "_nAPV").c_str(),         &event->nAPV,            (sname + "nAPV/I").c_str());
                tree->Branch((sname + "_apv_crate_id").c_str(), &event->apv_crate_id[0], (sname + "apv_crate_id[nAPV]/I").c_str());
                tree->Branch((sname + "_apv_mpd_id").c_str(),   &event->apv_mpd_id[0],   (sname + "apv_mpd_id[nAPV]/I").c_str());
                tree->Branch((sname + "_apv_adc_ch").c_str(),   &event->apv_adc_ch[0],   (sname + "apv_adc_ch[nAPV]/I").c_str());                
            }
            break;
        case kTI:
            {
